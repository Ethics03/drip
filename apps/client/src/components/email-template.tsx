...
export function VerificationEmail({ email, url }: VerificationEmailProps) {
    return (
        <Html>
            <Head />
            <Preview>Verify your email to start using Drip!</Preview>
                ...
                <Body className="font-sans">
                    <Container className="mx-auto my-[20px] px-4 py-5">
                        ...
                        <Section className="mt-8">
                            <Text className="text-2xl font-bold">Confirm your email address to start using Drip</Text>
                        </Section>

                        <Section className="mt-4">
                            <Text className="text-base">
                                You can start using Drip right away once you&apos;ve confirmed that{" "}
                        ...
                        <Section className="mt-4 text-center">
                            ...
                            >
                                <tr>
                                    <td> */}
                            <Button
                                className="bg-brand flex w-fit items-center justify-center rounded-lg px-6 py-3 text-center text-sm font-semibold text-white cursor-pointer"
                                href={url}
                            >
                        ...
                        <Section className="mt-4">
                            ...
                            <Text className="text-[0.75rem]">Drip | 2025</Text>
                        </Section>
                    </Container>
                </Body>
            </Tailwind>
